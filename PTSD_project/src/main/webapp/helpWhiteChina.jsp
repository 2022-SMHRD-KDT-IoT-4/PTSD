        ...
        <div class="circle">
         ...
         <div class="swiper-container" style="overflow:hidden;">
            <div class="swiper-wrapper">
	          ...
	          <div class="swiper-slide" style="background: #ebf5fc;">
				<h3 class = "korea_language1"><ruby font-size : 2rem>去附近的餐厅吧<rp>(</rp><rt>qù fùjìn de cāntīng ba</rt><rp>)</rp></ruby></h3>
	           	<h3 class = "korea_language2"><ruby font-size : 2rem>请去机场<rp>(</rp><rt>qǐng qù jīchǎng</rt><rp>)</rp></ruby></h3>
				<h3 class = "korea_language3"><ruby font-size : 2rem>请打开计程器<rp>(</rp><rt>qǐng dǎkāi jìchéngqì</rt><rp>)</rp></ruby></h3>
				<h3 class = "korea_language4"><ruby font-size : 2rem>请开空调<rp>(</rp><rt>qǐng kāi kōngtiáo</rt><rp>)</rp></ruby></h3>
