...
<link rel="stylesheet" type="text/css"
	href="assets/css/styleTourDark.css">
...
<body>
	...
	<div class="swiper-container" id="blur">
		...
		<div class="mainCountry">
			<!-- 메인 국기 아이콘-->
			<a href="darkMain.jsp"><span id="homeTour"></span></a> <a
				href="koreaTourDark.jsp"><span id="koreaTour"></span></a> <a
				href="englishTourDark.jsp"><span id="englishTour"></span></a> <a
				href="chinaTourDark.jsp"><span id="chinaTour"></span></a> <a
				href="japanTourDark.jsp"><span id="japanTour"></span></a>
		</div>
		<div class="circle">
			<div class="loader">
				<span></span>
